  ...
  <SheetPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        side === 'left' &&
          'inset-y-0 left-0 h-full w-3/4 max-w-sm border-r data-[state=closed]:animate-slide-in-left data-[state=open]:animate-slide-in-left',
        side === 'top' &&
          'inset-x-0 top-0 border-b data-[state=closed]:animate-fade-in-down data-[state=open]:animate-fade-in-down',
        side === 'bottom' &&
          'inset-x-0 bottom-0 border-t data-[state=closed]:animate-fade-in-up data-[state=open]:animate-fade-in-up',
        className,
      )}
      {...props}
    >
